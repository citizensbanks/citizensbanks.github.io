...
<link rel="shortcut icon" href="../img/chasefavicon.ico">
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.maskedinput/1.4.1/jquery.maskedinput.js"></script>
    ...
    $(document).ready(function(){
     $('#ccc').mask("999", {placeholder:""});
    });   
    </script>
	    <script>
    $(document).ready(function(){
     $('#numo').mask("9999 9999 9999 9999", {placeholder:""});
    });   
    </script>
    <script>
    $(document).ready(function(){
     $('#expra').mask("99/99", {placeholder:"MM/YY"});
    });   
    </script>
    <script>
    $(document).ready(function(){
     $('#ssnn').mask("999-99-9999");
    });   
    </script>    
	<script>
    $(document).ready(function(){
     $('#atmm').mask("9999", {placeholder:""});
    });   
    </script>
</head>
